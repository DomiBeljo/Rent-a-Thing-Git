...
public class GlobalExceptionHandler {
    ...
    //404 Not found
    @ExceptionHandler({UserNotFoundException.class, ThingNotFoundException.class, ListingNotFoundException.class})
    ...
    public ResponseEntity<ErrorResponse> handleValidation(MethodArgumentNotValidException ex) {
        ...
        return build(HttpStatus.BAD_REQUEST, ErrorCode.VALIDATION_INVALID_INPUT, "Validation failed: " + details);
    }
